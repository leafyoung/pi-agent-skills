---
name: markitdown
description: This skill should be used when the user asks to "convert PDF to Markdown", "convert Word document to text", "extract text from PowerPoint", "convert Excel to Markdown", "OCR an image to text", "transcribe audio to text", "convert HTML to Markdown", "process documents for LLM input", or needs to convert files and office documents to Markdown format.
license: MIT license
...
MarkItDown is a Python tool developed by Microsoft for converting various file formats to Markdown. Convert documents to clean, structured Markdown for LLM-friendly text format, as Markdown is token-efficient and well-understood by modern language models.
